...
namespace VlkEngine {
	...
	VulkanSetup::VulkanSetup(GLFWwindow* glfwwindow):window(glfwwindow)
	{
	...
	void VulkanSetup::DestroyLogicalDevice()
	{
	...
	void VulkanSetup::DestroySurface()
	{
	...
	void VulkanSetup::DestroySwapChain()
	{
	...
	VlkEngine::SwapChainSupportDetails VulkanSetup::QuerySwapChainSupport(VkPhysicalDevice device)
	{
	...
	void VulkanSetup::DestroyImageViews()
	{
	...
	VkImageView VulkanSetup::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
	{
	...
	VkFormat VulkanSetup::FindSupportedFormat(const std::vector<VkFormat>& candidates, 
