...
namespace VlkEngine {
	...
	void VulkanBase::DestroySwapChain()
	{
	...
	void VulkanBase::DestroyImageViews()
	{
	...
	void VulkanBase::DestroyRenderPass()
	{
	...
	void VulkanBase::DestroyGraphicsPipeline()
	{
	...
	void VulkanBase::DestroyFramebuffers()
	{
	...
	void VulkanBase::DestroyCommandPool()
	{
	...
	void VulkanBase::DestroyVertexBuffer()
	{
	...
	void VulkanBase::DestroyIndexBuffer()
	{
	...
	void VulkanBase::DestroyUniformBuffers()
	{
		for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
	...
	void VulkanBase::DestroyDepthResource()
	{
	...
	void VulkanBase::DestroySyncObjects()
	{
		for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
	...
	VkCommandBuffer VulkanBase::PreSingleTimeCommands(VkCommandPool cmdPool)
	{
		VkCommandBufferAllocateInfo allocInfo{};
		allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
		allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
	...
	void VulkanBase::PostSingleTimeCommands(VkCommandBuffer commandBuffer, VkCommandPool cmdPool)
	{
